...
if ( KSX.apps.tools === undefined ) KSX.apps.tools = {};
if ( KSX.apps.demos === undefined ) KSX.apps.demos = {};


KSX.apps.core.PlatformVerification = (function () {
...
var platformVerification = new KSX.apps.core.PlatformVerification();
