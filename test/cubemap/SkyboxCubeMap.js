...
if ( KSX.test.cubemap === undefined ) KSX.test.cubemap = {};

KSX.test.cubemap.SkyboxCubeMap = (function () {

    SkyboxCubeMap.prototype = Object.create(KSX.core.ThreeJsApp.prototype, {
        constructor: {
            configurable: true,
            enumerable: true,
            value: SkyboxCubeMap,
