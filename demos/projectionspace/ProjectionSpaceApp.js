...
if (KSX.demos.projectionspace === undefined) KSX.demos.projectionspace = {};

KSX.demos.projectionspace.Main = (function () {
    ...
    Home.prototype = Object.create(KSX.core.ThreeJsApp.prototype, {
        constructor: {
            configurable: true,
            enumerable: true,
            value: Home,
    ...
    function Home( elementToBindTo, elementNameVideo, elementNameVideoBuffer, mobileDevice ) {
        ...
        this.homeUi = new KSX.demos.projectionspace.Ui( this.mobileDevice, this.uiModel );
    ...
    var initRtt = function ( width, height, textStorage, textureCube ) {
        var canvasRtt = new KSX.core.Canvas( {
            offsetWidth: width,
            offsetHeight: height
        } );

        var rtt = new KSX.core.ThreeJsApp.ScenePerspective( canvasRtt );
        rtt.useCube = true;
        rtt.count = 0;
