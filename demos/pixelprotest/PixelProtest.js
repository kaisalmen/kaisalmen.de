...
if ( KSX.demos.pixelprotest === undefined ) KSX.demos.pixelprotest = {};

KSX.demos.pixelprotest.PixelProtest = (function () {

    PixelProtest.prototype = Object.create(KSX.core.ThreeJsApp.prototype, {
        constructor: {
            configurable: true,
            enumerable: true,
            value: PixelProtest,
    ...
    function PixelProtest( elementToBindTo, mobileDevice) {
        ...
        this.shader = new KSX.shader.PixelProtestShader( this.canvas.getWidth(), this.canvas.getHeight() );
        ...
        this.dataTools = new KSX.tools.DataTools();
    }
