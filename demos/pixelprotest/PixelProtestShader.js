...
KSX.shader.PixelProtestShader = (function () {
    ...
    PixelProtestShader.prototype = Object.create(KSX.shader.ShaderBase.prototype, {
        constructor: {
            configurable: true,
            enumerable: true,
    ...
    PixelProtestShader.prototype.loadResources = function (callbackOnSuccess) {
        ...
        promises.push( this.shaderTools.loadShader(this.baseDir + 'demos/pixelprotest/pureNoise.glsl', false, 'FS: Pure Noise') );
