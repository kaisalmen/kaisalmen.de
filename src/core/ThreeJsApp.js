...
KSX.core.ThreeJsAppDefaultDefinition = {
    name: 'None',
...
KSX.core.ThreeJsApp = (function () {
    ...
    function ThreeJsApp() {
        ...
        this.definition = KSX.core.ThreeJsAppDefaultDefinition;
    ...
    ThreeJsApp.prototype.configure = function ( userDefinition ) {
        ...
        this.canvas = new KSX.core.Canvas( this.definition.htmlCanvas );
        this.canvas.verbose = this.definition.verbose;

        if ( this.definition.useScenePerspective ) {

            this.scenePerspective = new KSX.core.ThreeJsApp.ScenePerspective( this.canvas );
        ...
        if ( this.definition.useSceneOrtho ) {
            ...
            this.sceneOrtho = new KSX.core.ThreeJsApp.SceneOrtho( this.canvas );
...
KSX.core.ThreeJsApp.ScenePerspective = (function () {
...
KSX.core.ThreeJsApp.SceneOrtho = (function () {
