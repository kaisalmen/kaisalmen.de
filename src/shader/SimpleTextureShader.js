...
KSX.shader.SimpleTextureShader = (function () {
    ...
    SimpleTextureShader.prototype = Object.create(KSX.shader.ShaderBase.prototype, {
        constructor: {
            configurable: true,
            enumerable: true,
    ...
    SimpleTextureShader.prototype.loadResources = function (callbackOnSuccess) {
        ...
        promises.push( this.shaderTools.loadShader(this.baseDir + 'src/shader/simpleTextureEffect.glsl', true, 'FS: Simple Texture') );
